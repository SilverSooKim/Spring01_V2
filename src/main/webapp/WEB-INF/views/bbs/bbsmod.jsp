	...
	<div id="wrap" align="center">
		...
		<form name="frm" method="post" action="bbsModAction" encType="multipart/form-data">
			...
			<table>
				<tr>
					<th>작성자</th>
					<td><input type="text" name="name" value="${boardVO.name }" readonly> * 필수
					<input type="hidden" name="num" value="${boardVO.num }"	>				
					</td>
				</tr>
				<tr>
					<th>비밀번호</th>
					<td><input type="password" value="${boardVO.pass }"  name="pass"> * 필수 (게시물 수정
						삭제시 필요합니다.)</td>
				</tr>
				<tr>
					<th>이메일</th>
					<td><input type="text" value="${boardVO.email }"  name="email"></td>
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" value="${boardVO.title }"  size="70" name="title"> * 필수</td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea cols="70" rows="15" name="content"> ${boardVO.content } </textarea></td>
				</tr>
		<!-- 		
				<tr>
					<th>첨부파일</th>
